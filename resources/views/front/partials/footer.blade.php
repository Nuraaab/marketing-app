<footer class="footer-wrapper section-bg section-padding pb-0">
            ...
            <div class="container">
                <div class="cta-banner-style-1 wow fadeInUp">
                    <div class="cta-banner" data-background="{{asset('front/assets/img/cta-banner/banner1.jpg')}}">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                            <div class="single-footer-widget">
                                <div class="widget-head">
                                    <a href="index.html">
                                    <img src="{{asset('front/assets/img/logo/footer-logo.png')}}" alt="footer-logo">
                                    </a>
                                </div>
                                <p>
                            ...
                            <div class="single-footer-widget">
                                ...
                                <div class="single-post-items">
                                    <div class="post-image">
                                        <img src="{{asset('front/assets/img/footer/post1.jpg')}}" alt="post-img">
                                    </div>
                                ...
                                <div class="single-post-items">
                                    <div class="post-image">
                                        <img src="{{asset('front/assets/img/footer/post2.jpg')}}" alt="post-img">
                                    </div>
                                    <div class="post-content">
                                        <ul>
                                            <li>
