    ...
    <div class="main-content">
      <!--breadcrumb-->
                ...
                <div class="d-flex align-items-start justify-content-between mb-3">
                  ...
                  <div class="col">
                  <div class="col">
                    <a href = "/view_project"type="button" class="btn btn-outline-primary btn-circle rounded-circle d-flex gap-2 wh-48"><i class="material-icons-outlined">remove_red_eye</i></a>
                  </div>
                  </div>
                  </div>
                </div>
